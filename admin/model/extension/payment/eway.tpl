  ...
  <div class="container-fluid">
	...
	<?php } ?>
      ...
      <div class="alert alert-info" style="overflow: hidden;">
          <div class="row">
              <div class="col-sm-8"><?php echo $text_connect_eway; ?></div>
              <div class="col-sm-4"><?php echo $text_eway_image; ?></div>
          </div>
      </div>
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-eway" class="form-horizontal">
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $entry_paymode; ?></label>
            <div class="col-sm-10">
