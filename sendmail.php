...
if($_POST['saveForm']=='Submit' and $_POST['Email']){
	...
	if($_POST['mod']=='1'){
		$subject = 'ranch Sponsorship Application'.$_POST[FirstName].$_POST[LastName];
		...
		$message.= "<tr><td><span style='color:#999'><br>Interested in which ranch , products</span></td></tr><tr><td>".$_POST[products]."</td></tr>";
		$message.= "<tr><td><span style='color:#999'><br>Why do you think you will be a good brand ambassador for ranch ?</span></td></tr><tr><td>".$_POST[ambassador]."</td></tr>";
	...
	if($_POST['mod']=='2'){
		...
		$subject = 'ranch Warranty Claim Form:'.$_POST[FirstName].$_POST[LastName];
		$message = "<html><head><title>".$subject."</title></head><body>";
		...
		//$message.= "<tr><td><br>Where did you buy your ranch?</td></tr><tr><td>".$_POST[Hidez]."</td></tr>";
		$message.= "</body></html>";
	}
