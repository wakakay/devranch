<?php
class ControllerExtensionModuleoutstckoptdis extends Controller {	
	private $error = array();
	private $modpath = 'module/outstckoptdis'; 
	private $modtpl = 'module/outstckoptdis.tpl';
	private $modname = 'outstckoptdis';
	private $modtext = 'Out Of Stock Product Option Disable';
	private $modid = '31671';
	private $modssl = 'SSL';
	...
	public function __construct($registry) {
		...
		if(substr(VERSION,0,3)>='3.0' || substr(VERSION,0,3)=='2.3') { 
			$this->modtpl = 'extension/module/outstckoptdis';
			$this->modpath = 'extension/module/outstckoptdis';
		} else if(substr(VERSION,0,3)=='2.2') {
			$this->modtpl = 'module/outstckoptdis';
		} 
	...
	public function index() {
		...
		$data[$this->modname.'_status'] = $this->setvalue($this->modname.'_status');	
 		$data[$this->modname.'_disopt'] = $this->setvalue($this->modname.'_disopt');	
		$data[$this->modname.'_outstcktext'] = $this->setvalue($this->modname.'_outstcktext');
	...
	public function uninstall() {		// uninstalled       
	}
}