...
if($this->config->get('outstckoptdis_status') && isset($this->request->get['product_id']) && $this->request->get['product_id'] > 0 && isset($this->request->get['route']) && stristr($this->request->get['route'], 'product/product')) {
